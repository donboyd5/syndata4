...
s9 <- read_csv(paste0(globals$tc.dir, "synthpop9_stack.csv"), 
...
#   gather(vname, value, -ftype, -rownum) %>%
#   spread(ftype, value) %>%
#   ht
...
b <- proc.time()
b - a # 9 minutes
saveRDS(mcounts, paste0(globals$tc.dir, "synthpop9_mcounts.rds"))
